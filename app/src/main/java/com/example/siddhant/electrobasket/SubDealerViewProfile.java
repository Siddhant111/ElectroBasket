...
public class SubDealerViewProfile extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sub_dealer_view_profile);
        ...
        db.addValueEventListener(new ValueEventListener() {
            ...
            public void onCancelled(@NonNull DatabaseError databaseError) {
                Toast.makeText(SubDealerViewProfile.this, "Cannot display profile", Toast.LENGTH_SHORT).show();
            }
        });
        ...
        save.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(SubDealerViewProfile.this, "data saved", Toast.LENGTH_SHORT).show();
