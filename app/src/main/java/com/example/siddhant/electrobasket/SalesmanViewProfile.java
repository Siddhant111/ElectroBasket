...
public class SalesmanViewProfile extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_salesman_view_profile);
        Intent i=getIntent();
        ...
        db.addValueEventListener(new ValueEventListener() {
            ...
            public void onCancelled(@NonNull DatabaseError databaseError) {
                Toast.makeText(SalesmanViewProfile.this, "Cannot display profile", Toast.LENGTH_SHORT).show();
            }
        });
        ...
        save.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(SalesmanViewProfile.this, "data saved", Toast.LENGTH_SHORT).show();
